  ...
  async run(message, args, data, embed) {
    ...
    try {
      embed
        ...
        .addField('<:DBL:489519574698426369> Discord Bot List', '[¡Clic aquí!](' + client.config.domain + '/dbl)', true)
        .addField('🔗 Enlace Directo', '[¡Clic aquí!](' + client.config.domain + '/invite)', true)
