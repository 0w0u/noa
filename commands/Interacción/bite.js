module.exports = class command extends require('../../base/models/Command.js') {
  ...
  async run(message, args, data, embed) {
    ...
    try {
      ...
      if (message.mentions.users.size < 1) return message.channel.send(client.message({ emoji: 'noidea', razón: 'noargs muerde a alguien, menos a mí', usage: this.help.usage(message.prefix), message }));
      embed
